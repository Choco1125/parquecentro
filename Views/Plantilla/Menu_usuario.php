  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item <?php echo ($this->active == 'inicio') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?php echo constant('URL') ?>Usuario">Inicio</a>
      </li>
      ...
      <li class="nav-item <?php echo ($this->active == 'reporte') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?php echo constant('URL') ?>Busqueda/reporte">Reporte</a>
      </li>
